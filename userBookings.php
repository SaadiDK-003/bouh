                ...
                <?php foreach ($appointments as $appointment): ?>
                    <div class="appointment-card" data-status="<?php echo $appointment['status']; ?>">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <?php else: ?>
                                            لا توجد نتائج
                                        <?php endif; ?>
                                        <a class="btn btn-outline" style="margin-right:8px;" href="assessment.php?type=ghq15">أداء GHQ-15</a>
                                    </li>
                                    <li>
                                        <strong>PHQ-9:</strong>
                                        ...
                                        <?php else: ?>
                                            لا توجد نتائج
                                        <?php endif; ?>
                                        <a class="btn btn-outline" style="margin-right:8px;" href="assessment.php?type=phq9">أداء PHQ-9</a>
                                    </li>
                                    <li>
                                        <strong>GAD-7:</strong>
                                        ...
                                        <?php else: ?>
                                            لا توجد نتائج
                                        <?php endif; ?>
                                        <a class="btn btn-outline" style="margin-right:8px;" href="assessment.php?type=gad7">أداء GAD-7</a>
                                    </li>
                                </ul>
                        ...
                        <div class="appointment-actions">
                            ...
                            <?php if (in_array($appointment['status'], ['pending','confirmed'])): ?>
                                <form method="POST" action="userBookings.php" class="status-form" onsubmit="return confirm('Cancel this appointment?');">
                            ...
                            <div class="review-section">
                                ...
                                <?php if (in_array($appointment['status'], ['pending','confirmed'])): ?>
                                    <form method="POST" action="userBookings.php" class="review-form">
                                        ...
                                        <label>تعليق:
                                            <textarea name="comment" rows="2" placeholder="اكتب رأيك..."><?php echo $existing ? htmlspecialchars($existing['comment']) : ''; ?></textarea>
                                        </label>
